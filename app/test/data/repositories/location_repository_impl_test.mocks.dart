...
// in storage_app/test/data/repositories/location_repository_impl_test.dart.
...
import 'package:storage_app/database/database_helper.dart' as _i4;
...
class MockDatabaseHelper extends _i1.Mock implements _i4.DatabaseHelper {
  ...
  @override
  int get currentTime =>
      (super.noSuchMethod(Invocation.getter(#currentTime), returnValue: 0)
          as int);
